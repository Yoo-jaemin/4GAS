...
lmp91000_enable(chNum);
if (i2c_writeBytes(0x90, buff, 2, 1) == 0)
return 0;
lmp91000_disable(chNum);
return 1;
}
...
if (lmp91000_get_status(&rBuff, chNum) == 0)
return 0;
...
switch(chNum)
{
case EN_CH0: LATBbits.LATB0 = 0; break;
case EN_CH1: LATBbits.LATB1 = 0; break;
case EN_CH2: LATBbits.LATB2 = 0; break;
}
}
...
switch(chNum)
{
case EN_CH0: LATBbits.LATB0 = 1; break;
case EN_CH1: LATBbits.LATB1 = 1; break;
case EN_CH2: LATBbits.LATB2 = 1; break;
}
}
